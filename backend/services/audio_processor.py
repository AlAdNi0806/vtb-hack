...
class AudioProcessor:
    ...
    async def initialize(self):
        ...
        try:
            ...
            # Initialize STT model (using Whisper as fallback for parakeet)
            await self._initialize_stt_model()
            
            # Initialize turn detector (simplified implementation)
    ...
    async def _initialize_stt_model(self):
        """Initialize Speech-to-Text model"""
        try:
            logger.info("Loading STT model...")
            
            # For now, we'll use Whisper as it's more readily available
            # You can replace this with parakeet-1.1b when available
